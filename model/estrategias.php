...
//--------- function insert($obj) --------------//
 ...
 //------------------ function update($obj)  ---------//
	...
	public static function update($obj) {
		 try{
		$stmt = Conexao::getInstance()->prepare("UPDATE estrategias SET id_estrategia = :id_estrategia , empresa = :empresa , projeto = :projeto , produtos_servicos = :produtos_servicos , links = :links , objetivo_primario = :objetivo_primario , kpis_primario = :kpis_primario , objetivo_secundario = :objetivo_secundario , kpis_secundario = :kpis_secundario , concorrentes = :concorrentes , com_quem_falar = :com_quem_falar , com_quem_nao_falar = :com_quem_nao_falar , abordar = :abordar , evitar = :evitar , linguagem = :linguagem , links_ref = :links_ref , categorias_conteudo = :categorias_conteudo , canais = :canais , acoes = :acoes , consideracoes_gerais = :consideracoes_gerais , projetos_id_projeto = :projetos_id_projeto  WHERE id_estrategia = :id_estrategia ");
