...
//--------- function insert($obj) --------------//
	...
	public static function insert($obj) {
		 try{
		$stmt = Conexao::getInstance()->prepare("INSERT INTO linguagens_estrategia (id_linguagem_estrategia, id_linguagem, id_estrategia)
 VALUES(:id_linguagem_estrategia, :id_linguagem, :id_estrategia);");
 ...
 //------------------ function select($id)---------//
	...
	public static function getById($id) {
	 ...
	 try {
		$stmt = Conexao::getInstance()->prepare("SELECT * FROM linguagens_estrategia WHERE id_estrategia = :id");
