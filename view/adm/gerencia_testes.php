...
$conteudos = conteudo_teste_candidato::getAllDetalhado();

?>
<html lang="pt-br">
    <head>
        <?php require_once './includes/header_includes.php'; ?>
        <title>Gerenciar Testes - PostSpot</title>
            ...
            <div class="main-panel">
                ...
                <div class="content">
                    <div class="container-fluid">
							<h4 class="title cor-roxo-escuro"><i class="material-icons md-48">settings</i> Gerenciar Testes</h4>
                        <div class="row">
                            <div class="col-md-12">
                            <div class="card">
	                            <div class="card-content">
									...
									<tbody>
										<?php foreach ($conteudos as $conteudo) { 					
											?>
											<tr>
												<td><?= $conteudo->id_conteudo_teste_candidato ?></td>
												<td><?= $conteudo->nome_teste_candidato ?></td>
												<td><?= $conteudo->nome_habilidade ?></td>
												<td>
													<a href="detalhes_teste.php?t=<?=$conteudo->id_conteudo_teste_candidato?>" target="_blank" class="btn btn-simple btn-info btn-icon"><i class="ti-eye"></i></a>
