                                        ...
                                        <div class="tab-pane" id="wizard-validation-step4" role="tabpanel">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <label>Selecione as áreas na qual gostaria de trabalhar (selecione até 05 opções)</label>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <button  type="button" class="btn btn-secondary" id="sorteiaTarefa">Gerar Pauta Teste</button>
                                                </div>
                                            </div>
                                                <?php //endif;?>
                                            <hr>
